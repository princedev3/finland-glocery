...
import { useDeleteSingleOrderMutation } from "@/app/_apis_/_order_index.apis";
...
export const orderColumns: ColumnDef<Order>[] = [
  {
    ...
    cell: ({ row }) => {
      const intentId = row.getValue("intentId");
      return <div className="hidden lg:block">{intentId as string}</div>;
    },
  },
  {
